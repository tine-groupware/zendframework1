...
class Zend_View_Helper_ServerUrl
{
    ...
    {
        $scheme = match (true) {
            isset($_SERVER['HTTPS']) && ($_SERVER['HTTPS'] == 'on' || $_SERVER['HTTPS'] === true), isset($_SERVER['HTTP_SCHEME']) && ($_SERVER['HTTP_SCHEME'] == 'https'), isset($_SERVER['SERVER_PORT']) && ($_SERVER['SERVER_PORT'] == 443) => 'https',
            default => 'http',
        };
